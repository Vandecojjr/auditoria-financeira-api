...
public class AuditoriaFinanceiraHandlerTest
{
    ...
    private readonly CriarUsuarioCommand _criarUsuarioComandoInvalido = new("Nome","",0);
    private readonly CriarUsuarioCommand _criarUsuarioComandoValido = new("Nome","SenhaSenha",0);
